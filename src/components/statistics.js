...
export default class Statistics extends AbstractSmartComponent {
  ...
  getTemplate() {
    return createStatisticsTemplate({tasks: this._tasks.getCards(), dateFrom: this._dateFrom, dateTo: this._dateTo});
  }
  ...
  _renderCharts() {
    ...
    this._daysChart = renderDaysChart(daysCtx, this._tasks.getCards(), this._dateFrom, this._dateTo);
    this._colorsChart = renderColorsChart(colorsCtx, this._tasks.getCards());
  }
